...
export default function TeacherDashboard() {
  ...
  return <div className="teacher-dashboard-page">
    <section className="teacher-dashboard-hero"><div><span className="hero-badge teacher-badge">ESPACE ENSEIGNANT</span><h1>Partage ton expertise, {user.name?.split(' ')[0]}.</h1><p>Publie des cours utiles et suis l’impact de tes contenus auprès des apprenants.</p></div><Link to="/upload" className="btn">+ Publier un cours</Link></section>
    <section className="teacher-stat-grid"><div className="teacher-stat"><span>▣</span><strong>{myVideos.length}</strong><small>Cours publiés</small></div><div className="teacher-stat"><span>◉</span><strong>{totalViews}</strong><small>Vues cumulées</small></div><div className="teacher-stat"><span>♧</span><strong>{reach}+</strong><small>Étudiants touchés</small></div><div className="teacher-stat"><span>★</span><strong>{averageRating}</strong><small>Note moyenne</small></div></section>
